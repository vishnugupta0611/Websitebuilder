...
function SavedItems() {
    ...
    const loadData = async () => {
        try {
            ...
            const websiteSavedItems = saved.filter(item => item.websiteSlug === slug)
    ...
    const handleRemoveItem = (itemId) => {
        ...
        // Update localStorage
        const allSavedItems = JSON.parse(localStorage.getItem('savedForLater') || '[]')
        const filteredItems = allSavedItems.filter(item => !(item.id === itemId && item.websiteSlug === slug))
        ...
        >
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                {savedItems.length === 0 ? (
                    ...
                    >
                        <Heart className="h-12 w-12 mx-auto mb-4" style={{ color: colors.secondary }} />
                        ...
                        {savedItems.map((item) => (
                            ...
                            >
                                ...
                                <div className="aspect-w-1 aspect-h-1">
                                    <img
                                        src={item.images?.[0] || 'https://via.placeholder.com/300x300/e5e7eb/9ca3af?text=Product'}
                                        alt={item.name}
