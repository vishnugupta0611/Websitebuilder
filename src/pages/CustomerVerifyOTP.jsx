...
function CustomerVerifyOTP() {
  ...
  const { verifyOTP, loading, error, clearError } = useCustomerAuth()
  ...
  const primaryColor = website?.customizations?.colors?.primary || '#3b82f6'
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-2">
              {website ? `Complete your ${website.name} account setup` : 'Complete your account setup'}
            </p>
